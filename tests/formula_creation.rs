...
mod tests {
    ...
    fn making_formulas_and_turning_them_into_strings() {
        ...
        assert_eq!(l1.to_string(), ("x1"));
        assert_eq!(l2.to_string(), ("!x2"));
        assert_eq!(l3.to_string(), ("x3"));
        assert_eq!(l4.to_string(), ("!x4"));
        assert_eq!(l5.to_string(), ("x5"));
        assert_eq!(l6.to_string(), ("!x6"));
        ...
        assert_eq!(c0.to_string(), ("(x1 | !x2 | x3)"));
        assert_eq!(c00.to_string(), ("(x1 | !x2 | x3)"));
        assert_eq!(c000.to_string(), ("(x1 | !x2 | x3)"));
        assert_eq!(c1.to_string(), ("(!x4 | x5)"));
        assert_eq!(c2.to_string(), ("(x1 | !x4 | x5 | !x6)"));
        ...
        assert_eq!(
            cnf0.to_string(),
            ("((!x4 | x5) & (x1 | !x2 | x3) & (x1 | !x4 | x5 | !x6))")
        );
        assert_eq!(cnf1.to_string(), ("((!x4 | x5) & (x1 | !x2 | x3))"));
    ...
    fn double_negation() {
        ...
        let l1_not = !l1;
        assert_eq!(l1_not.to_string(), ("!x1"));

        let l1_not_not = !l1_not;
        assert_eq!(l1_not_not.to_string(), ("x1"));
    }
}
